...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const dietPlan = {
        "Monday": { breakfast: "One glass milk", lunch: "steamed vegetables", dinner: "salad with chickpeas" },
        "Tuesday": { breakfast: "Vegitable Omelette", lunch: "Chicken and ", dinner: "Baked cod with roasted sweet potatoes" },
